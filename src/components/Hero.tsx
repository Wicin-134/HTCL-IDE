      ...
      <div className="container px-4 py-16 md:py-24 lg:py-32 mx-auto">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
            Experience the <span className="text-primary">Callback</span> Programming Language
          </h1>
          
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl">
            Callback Programming Language (CBPL) is an esoteric programming language designed to challenge conventional programming paradigms with its unique syntax and execution model.
          </p>
